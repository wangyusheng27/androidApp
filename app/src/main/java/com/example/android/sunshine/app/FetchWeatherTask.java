...
public class FetchWeatherTask extends AsyncTask<String, Void, Void> {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if (locationCursor.moveToFirst()) {
            ...
            return locationCursor.getLong(index);
        } else {
            ...
            Uri uri = mContext.getContentResolver().insert(WeatherContract.LocationEntry.CONTENT_URI, insertValues);
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if (cVVector.size() > 0) {
                ...
                mContext.getContentResolver().bulkInsert(WeatherContract.WeatherEntry.CONTENT_URI, cVVector.toArray(contentValues));
            }
    ...
    protected Void doInBackground(String... params) {
        ...
        try {
            ...
            final String APPID = "f24bd4b2d265dd3c8861f0642fa64045";
